...
export const QuotesPost = [Constants.FSPIOP_HEADERS_ACCEPT, Constants.FSPIOP_HEADERS_CONTENT_TYPE, Constants.FSPIOP_HEADERS_DATE, Constants.FSPIOP_HEADERS_SOURCE];
