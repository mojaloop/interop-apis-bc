...
export const RequiredHeaders = {
    participants: [FSPIOP_HEADERS_ACCEPT, FSPIOP_HEADERS_CONTENT_TYPE, FSPIOP_HEADERS_SOURCE, FSPIOP_HEADERS_DATE],
    parties: [FSPIOP_HEADERS_ACCEPT, FSPIOP_HEADERS_CONTENT_TYPE, FSPIOP_HEADERS_SOURCE, FSPIOP_HEADERS_DATE],
};